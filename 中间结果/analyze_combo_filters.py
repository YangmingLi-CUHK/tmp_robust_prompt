...
DETECTION_FIELDS = [
    ...
    "out_detect_pt_edges_auc",
    "out_detect_pt_edges_ap",
    "sim_pt_node_f1",
    "sim_pt_edge_f1",
    "sim_pt_edge_auc",
    "degree_pt_node_f1",
...
def parse_detection_metrics(text):
    ...
    for source in ["filter_module", "gppt_filter", "tau_tune", "out_detect_pt_edges"]:
        ...
        out[f"{source}_auc"] = mean_field(edge_rows, source, "auc")
        out[f"{source}_ap"] = mean_field(edge_rows, source, "ap")
    for tip in ["sim_pt", "degree_pt", "out_detect_pt"]:
        ...
        out[f"{tip}_edge_auc"] = mean_tip_field(tip_rows, tip, "edge_auc")
    return out
