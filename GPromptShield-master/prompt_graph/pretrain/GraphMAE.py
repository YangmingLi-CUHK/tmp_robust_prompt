...
class GraphMAE(PreTrain):
    ...
    def load_graph_data(self):
        ...
        if self.dataset_name in ['PubMed', 'Citeseer', 'Cora','Cora_ml','Computers', 'Photo', 'Reddit', 'WikiCS', 'Flickr', 'ogbn-arxiv', 'Actor', 'Texas', 'Wisconsin']:
        ...
        if self.dataset_name == 'ogbg-ppa':
             return DataLoader(self.graph_list, batch_size=256, shuffle=True)
        else:
    ...
    def pretrain(self):
        ...
        torch.save(self.gnn.state_dict(),
                    "./pre_trained_model/{}.{}.{}.{}.pth".format(self.dataset_name, 'GraphMAE', self.gnn_type, str(self.hid_dim) + 'hidden_dim'))
